...
USR="root"
HOME_PATH="/root"
RELEASE_URL="https://storage.googleapis.com/go-spacemesh-release-builds/v0.1.32/ubuntu-latest/go-spacemesh"
CLI_URL="https://github.com/spacemeshos/CLIWallet/releases/download/v0.0.1/cli_wallet_linux_amd64"
CONFIG_URL="https://discover.spacemesh.io/conf/29/config.json"
